            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Image(
                    modifier = Modifier
                        .width(24.dp)
                        .height(24.dp),
                    painter = painterResource(id = R.drawable.award_line),
            ...
            Row {
                Image(
                    modifier = Modifier
                        ...
                        .padding(top = Size120),
                    painter = painterResource(id = R.drawable.note_text_plus_line),
        ...
        Column {
            Row {
                OutlinedButton(
                    ...
                    contentPadding = PaddingValues(horizontal = 32.dp, vertical = Size120),
                    border = BorderStroke(width = SizeNone, color = Primary08),
